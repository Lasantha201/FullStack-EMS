...
const EmployeeForm = ({initialData, onSuccess, onCancel}) => {
  ...
  return (
    ...
    animate-fade-in">
            ...
            text-slate-700">
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        defaultValue={
                            initialData?.jointDate
                            ? initialData.jointDate.toISOString().split("T")[0]
                            : ""
                        }
                        />
                </div>
                ...
                <div className="sm:col-span-2">
                    ...
                    {initialData?.bio} rows={3} className="resize"
         ...
         <div className="card p-5 sm:p-6">
            ...
            <div>
                ...
                <div>
                    ...
                    min="0" defaultValue={initialData?.basicSalary || 0}/>
                </div>

                <div>
                    <label className="block mb-2">Allowances</label>
                    <input type= "number" name="allowances" min="0"
            ...
            text-slate-700">
                ...
                {!isEditMode && (
                 ...
                 {!isEditMode && (
                    ...
                    placeholder="Leave the blank to keep"/>
                </div>
                ...
                {isEditMode && (
                    ...
                    <select name="role" defaultValue={initialData?.user?.role
                        || "EMPLOYEE"
                    }>
        ...
        <div className="flex flex-col-reverese sm:flex-row justify-end
        gap-3 pt-2 ">
