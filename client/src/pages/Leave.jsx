  ...
  return (
    <div className="animate-fade-in">
      ...
      sm:items-center gap-4 mb-8">
        ...
        {!isAdmin && !isDeleted &&(
          <button onClick={()=> setShowModel(true)} className="btn-primary flex items-center gap-2 w-full
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mb-8">
          {leaveStats.map((s)=>(
            ...
            gap-4 relative overflow-hidden group">
              ...
              bg-slate-500/70 group-hover:bg-[#0A7C6E]"/>
              
              <div className="p-3 bg-slate-100 rounded-lg group-hover:bg-indigo-50
              transition-colors duration-200">
              <s.icon className="w-5 h-5 text-slate-600 group-hover:text-[#0A7C6E]
              transition-colors duration-200" />
      ...
      <LeaveHistory
        ...
        <ApplyLeaveModel open={showModel} onclose={()=> setShowModel(false)}
