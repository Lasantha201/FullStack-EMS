...
const LoginLanding = () => {
  ...
  const portalOptions = [
...

    {
      ...
      description: "View YOur Portal, track attendance, request time off, and access payslips.",
      icon: UserIcon
    }
  ]
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="mb-10 text-center md:text-left">
        ...
        <p className="text-slate-500">Select your portal to securely access to the system.</p>
      </div>
      ...
      <div className="space-y-4">
        {portalOptions.map((portal)=>(
          ...
          hover:border-[#0A7C6E] hover:bg-[#0A7C6E24]">

            <div className="relative z-10 flex items-center justify-between gap-4
            sm:gap-5">
              <h3 className="text-lg text-slate-800
              group-hover:text-[#0A7C6E] mb-1
              transition-colors">{portal.title}</h3>

              <ArrowRightIcon className="w-4 h-4 text-slate-600 group-hover:translate-x-1
              transition-all duration-300"/>
            </div>
      ...
      <div className="mt-12 text-center md:text-left text-sm text-slate-400">
        <p>© {new Date().getFullYear()} DeepCoder. All right reserved.</p>
      </div>
