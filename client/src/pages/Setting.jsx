...
const Setting = () => {
  ...
  return (
    <div className="animate-fade-in">
      ...
      {profile && <ProfileForm initialData={profile} omnSuccess={fetchProfile}/>}

      {/* Chamge Password trigger*/}
      ...
      <ChangePasswordMode open={showPasswordModel} onClose={()=> setShowPasswordModel(false)}/>
